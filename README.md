...
Neste repositório são disponibilizados alguns exemplos de operações, de maneira simplista, para a validação de dados. As ações de validação visam garantir a qualidade de diversas operações de entrada e saída de dados. 
