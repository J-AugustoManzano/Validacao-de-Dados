...
Neste repositório são disponibilizados alguns exemplos de operações gerais, de forma simplista em 9 linguagens de programação (C, C++, C#, Dart, Go, Java, Pascal, Python e Scala), para a validação de dados. 
